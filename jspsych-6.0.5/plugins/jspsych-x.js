...
jsPsych.plugins['x'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // display stimulus
    var html = '<img src="'+trial.stimulus+'" id="jspsych-x-stimulus"></img>';

     // show preamble text
     if(trial.preamble !== null){
      html += '<div id="jspsych-image-survey-text-preamble" class="jspsych-x-preamble">'+trial.preamble+'</div>';
    }

    // add questions
    for (var i = 0; i < trial.questions.length; i++) {
      html += '<div id="jspsych-x"'+i+'" class="jspsych-x-question" style="margin: 2em 0em;">';
      html += '<p class="jspsych-x">' + trial.questions[i].prompt + '</p>';
